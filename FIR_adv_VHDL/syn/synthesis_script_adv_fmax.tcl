...
elaborate myfir_adv -arch beh -lib WORK

# APPLYING CONSTRAINTS
# 1.45 slack 0 but violated bc of significant digits
...
# SAVE THE RESULTS
report_timing > report_timing_adv_fmax.txt
report_area > report_area_adv_fmax.txt
